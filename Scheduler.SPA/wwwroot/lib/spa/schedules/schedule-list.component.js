...
var ScheduleListComponent = (function () {
    function ScheduleListComponent(slimLoader, dataService, itemsService, notificationService, configService) {
    ...
    ScheduleListComponent.prototype.closed = function () {
        this.output = '(closed) ' + this.selected;
    };
    ScheduleListComponent.prototype.dismissed = function () {
        this.output = '(dismissed)';
    };
    ScheduleListComponent.prototype.opened = function () {
        var _this = this;
        this.slimLoader.start();
